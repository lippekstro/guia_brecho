...
<head>
  <meta charset="UTF-8">
  <title>cadastro dos eventos</title>
...
<body>
  <br>
    <form id="form-evento" action="inserir_evento.php" method="POST" enctype="multipart/form-data">
      <label>Nome do Evento:</label>
      <input type="text" name="nome_evento" required><br><br>
...
<select name="uf">
  ...
  <option value="SC">Santa Catarina</option>
      ...
      <input type="file" name="imagem_evento"><br><br>

      <label>Descrição do Evento:</label><br>
      <textarea name="descricao_evento" rows="4" required></textarea><br><br>
