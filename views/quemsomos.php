...
<div class="caixa-laranja" id="margem">
    <p>
        ...
        Como funciona o Guia Brechó? É simples! Nós fornecemos aos brechós locais uma plataforma para expor seus produtos, mostrando suas peças exclusivas e oferecendo informações detalhadas sobre suas lojas. Você poderá encontrar uma variedade de roupas, acessórios e itens de moda em nosso site, tudo em um só lugar!
    </p>
</div>
...
<div class="caixa-laranja">
    <p>
        Ao navegar pelo Guia Brechó, você terá acesso a uma seleção cuidadosamente curada de brechós em São Luís do Maranhão, onde poderá encontrar produtos únicos e de qualidade, contribuindo para uma moda mais sustentável e consciente. 
    </p>
</div>
...
<div class="caixa-laranja">
    <p>
        Estamos comprometidos em promover o crescimento dos brechós locais e ajudá-los a alcançar um maior número de clientes, enquanto proporcionamos aos apreciadores de moda consciente uma experiência única de descoberta e valorização de produtos únicos e especiais.
